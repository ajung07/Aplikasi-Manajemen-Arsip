                        ...
                        <div class="z-depth-1">
                            <nav class="secondary-nav">
                                <div class="nav-wrapper blue darken-1">
                                    <div class="col m7">
                                        <ul class="left">
                                            <li class="waves-effect waves-light hide-on-small-only"><a href="?page=tsm" class="judul"><i class="material-icons"></i> Data </a></li>
                    ...
                    <!-- Row form END -->';
                        ...
                        <div class="col m12" id="colres">
                            <table class="bordered" id="tbl">
                                <thead class="blue lighten-4" id="head">
                                    <tr>
                                        <th width="10%">No /<br/> Kode Klasifikasi </th>
                                        <th width="50%">Keterangan <br/> File</th>
                                        <th width="24%">Jenis Arsip </th>
                                        <th width="18%">Kode / Jenis <br/>/ Tgl Surat</th>
