                            ...
                            <div class="z-depth-1">
                                <nav class="secondary-nav">
                                    <div class="nav-wrapper blue-grey darken-1">
                                        <div class="col m12">
                                            <ul class="left">
                                                <li class="waves-effect waves-light"><a href="?page=gsk" class="judul"><i class="material-icons">image</i> Galeri </a></li>
                                            </ul>
                                        </div>
                                    </div>
                                </nav>
                    ...
                    if(isset($_REQUEST['submit'])){
                        ...
                        echo '<!-- Row form Start -->
                            ...
                            <div class="row agenda">
                                <div class="col s12"><p class="warna agenda">Galeri antara tanggal <strong>'.indoDate($dari_tanggal).'</strong> sampai dengan tanggal <strong>'.indoDate($sampai_tanggal).'</strong></p>
                                </div>
                            </div>';
