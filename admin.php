        ...
        if(isset($_REQUEST['page'])){
            ...
            switch ($page) {
                ...
                case 'gsk':
                    ...
                    break;
                case 'tf':
                    include "transaksi_foto.php";
                    break;
                case 'gf':
                    include "galeri_foto.php";
                    break;
            }
        } else {
    ?>
                    ...
                    <div class="card-content">
                        ...
                        <?php
                            if($_SESSION['admin'] == 1){
                                ...
                                echo "<strong>Administrator</strong>. Berikut adalah data yang tersimpan dalam sistem.";
                            } else {
                                echo "<strong>User Biasa </strong>. Berikut adalah data yang tersimpan dalam sistem.";
                            }?></p>
                    </div>
                </div>
            </div>
