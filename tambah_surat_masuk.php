                ...
                <div class="col s12">
                    <nav class="secondary-nav">
                        <div class="nav-wrapper blue darken-1">
                            <ul class="left">
                                <li class="waves-effect waves-light"><a href="?page=tsm&act=add" class="judul"><i class="material-icons"></i> Tambah Data </a></li>
                            </ul>
                        </div>
                    </nav>
                </div>
                        ...
                        <div class="input-field col s6">
                           <!-- <i class="material-icons prefix md-prefix">place</i> -->
                            <input id="asal_surat" type="text" class="validate" name="asal_surat" required>
                                ...
                                ?>
                            <label for="asal_surat">Jenis Arsip</label>
                        </div>
                        <div class="input-field col s6">
                        ...
                        <div class="input-field col s6">
                           <!-- <i class="material-icons prefix md-prefix">looks_two</i> -->
                            <input id="no_surat" type="text" class="validate" name="no_surat" required>
                                ...
                                ?>
                            <label for="no_surat">Kode / Jenis</label>
                        </div>
                        <div class="input-field col s6">
