                    ...
                    <div class="row jarak-form">
                        ...
                        if(empty($row['file'])){
                            ...
                            if(in_array($eks, $ekstensi) == true){
                                echo '<img class="gbr" data-caption="'.date('d M Y', strtotime($row['tgl_diterima'])).'" src="./upload/foto/'.$row['file'].'"/>';
                            } else {
                                                ...
                                                <div class="col s9 left">
                                                    <div class="card">
                                                        ...
                                                        <div class="card-action">
                                                            <strong>Lihat file :</strong> <a class="blue-text" href="./upload/foto/'.$row['file'].'" target="_blank">'.$row['file'].'</a>
                                                        </div>
                                                    </div>
                                                </div>
