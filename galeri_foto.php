                ...
                if(empty($pg)){
                            ...
                            <div class="z-depth-1">
                                <nav class="secondary-nav">
                                    <div class="nav-wrapper blue darken-1">
                                        <div class="col m12">
                                            <ul class="left">
                                                <li class="waves-effect waves-light"><a href="?page=gf" class="judul"><i class="material-icons">image</i> Galeri </a></li>
                                            </ul>
                                        </div>
                                    </div>
                                </nav>
                    ...
                    if(isset($_REQUEST['submit'])){
                        ...
                        if($_REQUEST['dari_tanggal'] == "" || $_REQUEST['sampai_tanggal'] == ""){
                            header("Location: ./admin.php?page=gf");
                            die();
                        } else {

                        $query = mysqli_query($config, "SELECT * FROM tb_foto WHERE tgl_diterima BETWEEN '$dari_tanggal' AND '$sampai_tanggal' ORDER By id_surat DESC LIMIT 10");
                            ...
                            if(mysqli_num_rows($query) > 0){
                                ...
                                if(empty($row['file'])){
                                 ...
                                 if(in_array($eks, $ekstensi) == true){
                                        echo '
                                            <div class="col m3">
                                               <img class="galeri materialboxed" data-caption="'.indoDate($row['tgl_diterima']).'" src="./upload/foto/'.$row['file'].'"/>
                                        ...
                                        if(in_array($eks, $ekstensi2) == true){
                                            echo '
                                                <div class="col m3">
                                                    ...
                                                    <a class="btn light-green darken-1" href="?page=gf&act=fsm&id_surat='.$row['id_surat'].'">Lihat Detail File</a>
                                                </div>';
                                        } else {
                                            echo '
                                                <div class="col m3">
                        ...
                        if($pg > 1){
                            $prev = $pg - 1;
                            echo '<li><a href="?page=gf&pg=1"><i class="material-icons md-48">first_page</i></a></li>
                                  <li><a href="?page=gf&pg='.$prev.'"><i class="material-icons md-48">chevron_left</i></a></li>';
                        } else {
                        ...
                        for ($i = 1; $i <= $cpg; $i++) {
                            if ((($i >= $pg - 3) && ($i <= $pg + 3)) || ($i == 1) || ($i == $cpg)) {
                                if ($i == $pg) echo '<li class="active waves-effect waves-dark"><a href="?page=gf&pg='.$i.'"> '.$i.' </a></li>';
                                else echo '<li class="waves-effect waves-dark"><a href="?page=gf&pg='.$i.'"> '.$i.' </a></li>';
                            }
                        }
                        ...
                        if($pg < $cpg){
                            $next = $pg + 1;
                            echo '<li><a href="?page=gf&pg='.$next.'"><i class="material-icons md-48">chevron_right</i></a></li>
                                  <li><a href="?page=gf&pg='.$cpg.'"><i class="material-icons md-48">last_page</i></a></li>';
                        } else {
